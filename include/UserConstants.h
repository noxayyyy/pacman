...
const SDL_Point MAP_PADDING { 16, 0 };   ///< The pixel padding for rendering the map on screen.
const SDL_Point MAP_SIZE { 14, 16 };     ///< The dimensions of the map grid.
...
const float MAP_TILE_SCALE = 0.32f;

// game
const std::string PACMAN_TAG = "pacman";            ///< The entity ID tag for the player.
const SDL_Point PACMAN_SPAWN { MAP_SIZE.x - 1, 1 }; ///< The initial grid coordinates for Pac-Man.
